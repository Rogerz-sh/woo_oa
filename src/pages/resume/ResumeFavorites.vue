<template>
    <div>
        ...
        <fav-adder
            :is-hidden="!$store.state.showFavAdder"
...
export default {
    ...
    methods: {
        ...
        getResumeData: function() {
            this.$http
                .get("/api/resume/json-resume-favorites", {
                    params: {
        ...
        delResume: function(data, idx) {
            this.$http
                .post("/api/resume/remove-resume-favorite", {
                    resumeId: data.id,
                    favId: this.fid
                })
                .then(res => {
    ...
    mounted: function() {
        var self = this;
        this.$store.commit("activeFav", this.fid);
        self.getResumeData();
    }
};
</script>
